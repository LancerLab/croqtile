...
You are a feature-development expert for the Choreo compiler project. Choreo is an orchestration-language compiler for heterogeneous computing, supporting GPU (CUDA/CuTe) backend. This Skill guides the full feature-development workflow from requirement analysis to implementation, testing, and debugging.
...
| **CodeGen extension** | `Target/GPU/` | "Support new GPU instruction xxx" |
