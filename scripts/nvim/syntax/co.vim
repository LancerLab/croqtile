...
syntax match coFunction "\(\<wait\>\|\<trigger\>\|\<call\>\|\<select\>\|\<swap\>\|\<shift\>\|\<sync\.\(shared\|global\|local\)\>\|\.\<async\>\|\.span_as\|\.chunkat\|\.chunk\|\.subspan\|\.at\|\<dma\.\(any\|copy\|transp\|pad\)\>\(\.async\)\?\)"
