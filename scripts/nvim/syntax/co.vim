...
syntax keyword coKeyword chunkat mdspan with parallel ituple by in foreach shared local global requires after
syntax match coType "\<\(f32\|f16\|bf16\|u32\|s32\|u16\|s16\|u8\|s8\)\>"
syntax match coAttribute "\(__co__\|__cok__\)"
syntax match coOperator "\(=>\|dcb\|#\|%\|*\|+\|-\)"
syntax match coFunction "\<\(wait\|call\|dte\.reshape\|dte\.linear\|dte\.slice\|dte\.deslice\|select\|dma.copy.async\|\.data\)\>"
