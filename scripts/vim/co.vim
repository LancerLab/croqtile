...
syntax match coFunction "\(\<wait\>\|\<trigger\>\|\<call\>\|\<select\>\|\<swap\>\|\<shift\>\|\<sync\.\(shared\|global\|local\)\>\|\.\<async\>\|\.span_as\|\.chunkat\|\.chunk\|\.subspan\|\.modspan\|\.stride\|\.at\|\<dma\.\(any\|copy\|transp\|pad\)\>\(\.async\)\?\|\<mma\.\(fill\|load_a\|load_b\|store\|row\.col\|row\.row\|col\.row\|col\.col\)\>\(\.async\)\?\)"
