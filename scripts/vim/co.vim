...
syntax keyword coKeyword chunkat mdspan with parallel ituple by in foreach shared local global where after incr while inthreads event
...
syntax match coFunction "\(\<wait\>\|\<trigger\>\|\<call\>\|\<\.span_as\>\|\<\.chunk_at\>\|\<select\>\|\<swap\>\|\<shift\>\|\<sync\.\(shared\|global\|local\)\>\|\.\<async\>\|\<dma\.\(any\|copy\|transp\|pad\)\>\(\.async\)\?\)"
