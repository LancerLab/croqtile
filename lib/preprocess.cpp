...
static inline std::string UniquePath() {
...
std::vector<Bundle> SimplePreprocessor::find_bundles(const std::string& code) {
...
std::vector<Range>
SimplePreprocessor::extract_cok_sections(const std::string& code,
                                         size_t base_offset) {
...
void SimplePreprocessor::EmitScript(std::ostream& os) {
...
std::string SimplePreprocessor::SubStituteMacroFuncs(const std::string& line,
                                                     const FuncMap& funcs,
                                                     bool& changed) {
...
std::string SimplePreprocessor::SubStituteDefines(const std::string& line,
...
std::string
SimplePreprocessor::SubstituteGlobalDefines(const std::string& line) {
  return SubStituteDefines(line, globalDefines, globalDefinedFuncs);
}

std::string
SimplePreprocessor::SubstituteLocalDefines(const std::string& line) {
  return SubStituteDefines(line, localDefines, localDefinedFuncs);
}

std::string
SimplePreprocessor::SubstituteGlobalMacroFuncs(const std::string& line,
                                               bool& changed) {
  return SubStituteMacroFuncs(line, globalDefinedFuncs, changed);
}

std::string
SimplePreprocessor::SubstituteLocalMacroFuncs(const std::string& line,
                                              bool& changed) {
  return SubStituteMacroFuncs(line, localDefinedFuncs, changed);
}

bool SimplePreprocessor::isDirective(const std::string& line,
...
std::string SimplePreprocessor::preprocessBooleanExpression(
...
bool SimplePreprocessor::EvaluateBooleanExpression(
    const std::string& condition_expr, const DefineMap& defines) {
  std::unordered_map<std::string, bool> macroMap;
...
const std::string SimplePreprocessor::HandleCComments(const std::string& line) {
...
void SimplePreprocessor::HandleOneUserLine(const std::string& line) {
...
void SimplePreprocessor::HandleOneKernelLine(const std::string& line,
                                             bool handle_comment) {
...
void SimplePreprocessor::HandleOneChoreoLine(const std::string& line,
                                             bool handle_comment) {
...
bool SimplePreprocessor::ExtractDeviceKernel(std::stringstream& cok_ss) {
...
bool SimplePreprocessor::Process(std::istream& input) {
  code_partition = CP_USER;
  std::string cur_line;
