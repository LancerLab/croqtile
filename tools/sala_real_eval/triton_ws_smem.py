"""
Measure Triton WS vs no-WS shared memory via ncu.
Runs a simple kernel and measures SMEM with ncu.
"""
...
if __name__ == "__main__":
    ws = "--ws" in sys.argv
    label = "WS" if ws else "No-WS"
    print(f"Running Triton GEMM ({label})...")
    run_one(ws)
    print(f"Done ({label})")
