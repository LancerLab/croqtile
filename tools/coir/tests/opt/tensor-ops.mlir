...
coir.kernel @test_tensor_alloc() {
  // CHECK: coir.tensor.alloc : !coir.tensor<128x256xf16>
...
coir.kernel @test_tensor_tile(%a: !coir.tensor<128x64xf16>) {
  ...
  // CHECK: coir.tensor.tile %arg0[%c0, %c1] : !coir.tensor<128x64xf16> -> !coir.tensor<16x16xf16>
...
coir.kernel @test_tensor_store(
  ...
  %c0 = arith.constant 0 : index
  // CHECK: coir.tensor.store_tile %arg0, %arg1[%c0] : !coir.tensor<16x16xf16>, !coir.tensor<128x64xf16>
