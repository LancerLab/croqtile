...
if(_FC_URL)
  ...
  if(_dl_code EQUAL 0 AND _FC_MD5)
    file(MD5 "${_archive}" _actual_md5)
    if(NOT _actual_md5 STREQUAL _FC_MD5)
      file(REMOVE "${_archive}")
      set(_dl_code 1)
      set(_dl_msg "MD5 mismatch: expected ${_FC_MD5}, got ${_actual_md5}")
    endif()
  endif()
  if(_dl_code EQUAL 0)
    ...
    if(_fallback_url)
      message(STATUS "FileCheck: trying fallback ${_fallback_url}")
      ...
      if(_dl_code EQUAL 0 AND _FC_MD5)
        ...
        if(NOT _actual_md5 STREQUAL _FC_MD5)
          ...
          set(_dl_code 1)
          set(_dl_msg
            "MD5 mismatch: expected ${_FC_MD5}, got ${_actual_md5}")
        endif()
      endif()
      if(_dl_code EQUAL 0)
        file(MAKE_DIRECTORY "${CMAKE_SOURCE_DIR}/extern/bin")
