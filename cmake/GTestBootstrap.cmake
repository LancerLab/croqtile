...
if(_dl_code EQUAL 0 AND _GTEST_MD5)
  file(MD5 "${_archive}" _actual_md5)
  if(NOT _actual_md5 STREQUAL _GTEST_MD5)
    file(REMOVE "${_archive}")
    set(_dl_code 1)
    set(_dl_msg "MD5 mismatch: expected ${_GTEST_MD5}, got ${_actual_md5}")
  endif()
endif()
if(NOT _dl_code EQUAL 0)
  list(GET _dl_status 1 _dl_msg)
  if(_fallback_url)
    message(STATUS "GTest: trying fallback ${_fallback_url}")
    ...
    if(_dl_code EQUAL 0 AND _GTEST_MD5)
      ...
      if(NOT _actual_md5 STREQUAL _GTEST_MD5)
        ...
        set(_dl_code 1)
        set(_dl_msg
          "MD5 mismatch: expected ${_GTEST_MD5}, got ${_actual_md5}")
      endif()
    endif()
  endif()
endif()
