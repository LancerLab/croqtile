...
__choreo_wgmma_64x64x16_f32f16f16_ss_kk(uint64_t, uint64_t, float*);
extern __device__ void
__choreo_wgmma_64x128x16_f32f16f16_ss_kk(uint64_t, uint64_t, float*);
extern __device__ void
__choreo_wgmma_64x256x16_f32f16f16_ss_kk(uint64_t, uint64_t, float*);

// WGMMA fma wrappers -- F16 accumulator, F16 inputs, SS K-major
extern __device__ void
__choreo_wgmma_64x64x16_f16f16f16_ss_kk(uint64_t, uint64_t, uint32_t*);
extern __device__ void
__choreo_wgmma_64x128x16_f16f16f16_ss_kk(uint64_t, uint64_t, uint32_t*);
extern __device__ void
__choreo_wgmma_64x256x16_f16f16f16_ss_kk(uint64_t, uint64_t, uint32_t*);

// Fragment store wrappers
extern __device__ void __choreo_store_fragment_d_m64k16_f16_f32(f16*, int, int,
                                                                float* const);
extern __device__ void __choreo_store_fragment_d_m64k16_dyn(f16*, int,
                                                            float* const);

// TMA copy wrappers
extern __device__ void
__choreo_tma_load_2d(void*, const CUtensorMap*,
                     cuda::barrier<cuda::thread_scope_block>&, int, int);
extern __device__ void __choreo_tma_store_2d(const CUtensorMap*, int, int,
                                             void*);
